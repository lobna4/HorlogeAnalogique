...
var maDate = new Date(); //console.log(maDate);
//Stocker l'heure , minute , seconde  dans des varaiables

var monHeure = maDate.getHours();
var maMin = maDate.getMinutes();
var maSec = maDate.getSeconds();
...
var formatHeure = monHeure + ":" + maMin + ":" + maSec;
console.log(formatHeure); // Calculer de degré de mouvement de l'aiguille heure, de l'aiguille minute, de l'aiguille seconde
